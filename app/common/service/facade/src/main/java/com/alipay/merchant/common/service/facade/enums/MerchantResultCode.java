...
import static com.alipay.merchant.common.service.facade.enums.ErrorCodeConstants.PREFIX;

public enum MerchantResultCode {
    ...
    MerchantResultCode(String code, String description) {
        this.code = code;
        this.description = description;
    }

    MerchantResultCode(String level, String bizError, String bizType, String errorSpecific, String description) {
